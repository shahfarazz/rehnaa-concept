...
class AdminRentOffWinnerPage extends StatefulWidget {
  @override
  _AdminRentOffWinnerPageState createState() =>
      _AdminRentOffWinnerPageState();
}

class _AdminRentOffWinnerPageState
    extends State<AdminRentOffWinnerPage> {
      ...
      child: ListTile(
        leading: CircleAvatar(
          backgroundImage: AssetImage(
            landlord.pathToImage ?? 'assets/placeholder.png',
          ),
        ),
        title: Text(
        ...
        onTap: () async {
              ...
              return AlertDialog(
                ...
                content: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    // errorText: isNumeric(controller.text)
                    //     ? null
          ...
          if (discount != null) {
            // Apply the discount to the landlord's balance
          }
        },
      ),
    );
