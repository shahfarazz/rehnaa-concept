...
class DealerInvoicePage extends StatefulWidget {
  ...
  DealerInvoicePage({required this.dealerName, required this.balance , required this.amount , required this.transactionMode, required this.id});

  @override
  _DealerInvoicePageState createState() => _DealerInvoicePageState();
}

class _DealerInvoicePageState extends State<DealerInvoicePage> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => DealerDashboardPage(uid: widget.id,),
            ));
          },
        ),
        actions: [
